...
@export var glow_color: Color = Color(0.0, 1.0, 0.55, 1.0)
@export var flicker_speed: float = 2.5
@export var flicker_min: float = 0.75   # minimum brightness during flicker
...
func _ready() -> void:
	...
	add_theme_color_override("font_shadow_color", Color(0.0, 0.8, 0.4, 0.5))
